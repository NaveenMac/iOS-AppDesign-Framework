...
protocol ViewProtocol {
    ...
    func setTextStyle(label:PaddedLabel, style:[Style])
    func setImageStyle(image:UIImageView, style:[Style])
    func setRelativeStackStyle(view:UIView,relativeView:UIView, style:[Style])
    func setStackStyle(stack:UIView, style:[Style])
...
extension ViewProtocol{
    ...
    func setButtonStyle(button:UIButton, style:[Style]){
        for property in style {
            switch property.attr {
            case Attributes.width.rawValue:
                NSLayoutConstraint.activate([
    ...
    func setTableStyle(table:UITableView, style:[Style]){
    ...
    func setRelativeViewStyle(view:UIView, style:[Style], relativeView: UIView){
    ...
    func setZStackStyle(view:UIView, style:[Style]){
        for property in style {
            switch property.attr {
            case Attributes.width.rawValue:
                NSLayoutConstraint.activate([
